...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-12 md:py-16 lg:py-20 bg-white relative overflow-hidden">
      {/* Background decoration */}
      <div className="absolute top-0 right-0 bg-blue-100 w-1/4 md:w-1/3 h-full opacity-50 rounded-l-full"></div>
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-start">
            ...
            <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-3 sm:px-4 py-2 sm:py-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm"
                />
              </div>
              ...
              <button
                ...
                className={`w-full flex items-center justify-center gap-2 py-2 sm:py-3 px-4 sm:px-6 rounded-lg text-white font-medium transition-all text-sm sm:text-base ${
          ...
          >
            <div className="bg-gradient-to-br from-blue-600 to-blue-800 rounded-xl shadow-xl p-5 sm:p-6 md:p-8 text-white">
              <h3 className="text-xl sm:text-2xl font-bold mb-4 sm:mb-6">{t('contact.info')}</h3>
              ...
              <div className="space-y-4 sm:space-y-6">
                <div className="flex items-start gap-3 sm:gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/80 text-xs sm:text-sm">{t('contact.location')}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 sm:gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/80 text-xs sm:text-sm">+1 (438) 870-9696</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 sm:gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/80 text-xs sm:text-sm break-all">inka_express024@hotmail.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 sm:gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/80 text-xs sm:text-sm whitespace-pre-line">{t('contact.schedule')}</p>
                  </div>
                </div>
              </div>
            </div>
